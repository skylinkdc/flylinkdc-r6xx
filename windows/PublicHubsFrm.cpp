...
LRESULT PublicHubsFrame::onCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
	...
	SetSplitterExtendedStyle(SPLIT_PROPORTIONAL); // Ïðè èçìåíåíèè ðàçìåðîâ îêíà-êîíòåéíåðà ðàçìåðû ðàçäåëÿåìûõ îáëàñòåé ìåíÿþòñÿ ïðîïîðöèîíàëüíî.
